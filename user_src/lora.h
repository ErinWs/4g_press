...
#define  MD_LORA_EN_PIN_RESET     1// P4.5=0
#define  MD_LORA_EN_PIN_SET       1//P4.5=1
#define  MD_LORA_SET_PIN_RESET    1//P4.4=0
#define  MD_LORA_SET_PIN_SET      1//P4.4=1
...
typedef struct _LORA_COMPONENTS
{
    ...
    int (*read_yl701_info)(void const *,int);
