...
*/
/* Selection of operation clock (PRSm03 - PRSm00) */
...
/* Selection of operation clock (PRSm13 - PRSm10) */
...
*/
/* Selection of operation clock (fMCK) of channel n (CKSmn1 - CKSmn0) */
#define _0000_TAU_CLOCK_SELECT_CKM0             (0x0000U) /* operation clock CKm0 set by timer clock select register m (TPSm) */ 
#define _8000_TAU_CLOCK_SELECT_CKM1             (0x8000U) /* operation clock CKm1 set by timer clock select register m (TPSm) */ 
#define _4000_TAU_CLOCK_SELECT_CKM2             (0x4000U) /* operation clock CKm2 set by timer clock select register m (TPSm) */ 
#define _C000_TAU_CLOCK_SELECT_CKM3             (0xC000U) /* operation clock CKm3 set by timer clock select register m (TPSm) */ 
/* Selection of count clock (fTCLK) of channel n (CCSmn) */
#define _0000_TAU_CLOCK_MODE_CKS                (0x0000U) /* operation clock (fMCK) specified by the CKSmn0 and CKSmn1 bits */  
...
/* Selection of 8 or 16-bit timer operation for channels 1 and 3 (SPLITmn) */
