...
#define _10_CGC_SUB_OSC             (0x10U) /* XT1, XT2 as crystal resonator connection */
...
*/
/* Setting in STOP mode or in HALT mode while subsystem clock is selected as CPU clock (RTCLPC) */
#define _00_CGC_SUBINHALT_ON        (0x00U) /* enables supply of subsystem clock to peripheral functions */
#define _80_CGC_SUBINHALT_OFF       (0x80U) /* stops supply to peripheral functions except RTC2, interval timer, PCLBUZ and LCD */
/* Selection of operation clock for real-time clock 2, 12-bit interval timer, and LCD driver/controller (WUTMMCK0) */
...
Macro definitions
***********************************************************************************************************************/
#define CGC_SUBWAITTIME             (30U)   /* change the waiting time according to the system */
