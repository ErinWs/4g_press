...
#define _12_LCD_DISPLAY_MODE5             (0x10U) /* 6 time slices, 1/4 bias mode */
...
/* Voltage boost circuit operation enable/disable (VLCON) */
#define _00_LCD_BOOST_CAPACITOR_DISABLE   (0x00U) /* stops voltage boost circuit operation */
#define _20_LCD_BOOST_CAPACITOR_ENABLE    (0x20U) /* enables voltage boost circuit operation */
