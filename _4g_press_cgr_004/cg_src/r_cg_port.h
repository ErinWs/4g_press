...
/*
    Pull-up Resistor Option Registers (PUm)
*/
...
/*
    Port Input Mode Registers (PIMm)
*/
...
/*
    Port Output Mode Registers (POMm)
*/
/* Pmn pin output mode selection (POMmn) */
#define _00_POMn0_NCH_OFF       (0x00U) /* set Pn0 normal output mode */
#define _01_POMn0_NCH_ON        (0x01U) /* set Pn0 N-ch open-drain output mode */
#define _00_POMn2_NCH_OFF       (0x00U) /* set Pn2 normal output mode */
#define _04_POMn2_NCH_ON        (0x04U) /* set Pn2 N-ch open-drain output mode */
#define _00_POMn3_NCH_OFF       (0x00U) /* set Pn3 normal output mode */
#define _08_POMn3_NCH_ON        (0x08U) /* set Pn3 N-ch open-drain output mode */
#define _00_POMn4_NCH_OFF       (0x00U) /* set Pn4 normal output mode */
#define _10_POMn4_NCH_ON        (0x10U) /* set Pn4 N-ch open-drain output mode */
#define _00_POMn5_NCH_OFF       (0x00U) /* set Pn5 normal output mode */
#define _20_POMn5_NCH_ON        (0x20U) /* set Pn5 N-ch open-drain output mode */
#define _00_POMn6_NCH_OFF       (0x00U) /* set Pn6 normal output mode */
#define _40_POMn6_NCH_ON        (0x40U) /* set Pn6 N-ch open-drain output mode */
#define _00_POMn7_NCH_OFF       (0x00U) /* set Pn7 normal output mode */
#define _80_POMn7_NCH_ON        (0x80U) /* set Pn7 N-ch open-drain output mode */

/*
    Port Mode Control Registers (PMCm)
*/
/* Pmn pin digital digital I/O/analog input selection (PMCmn) */
...
/*
    LCD port function registers 6 (PFSEG6)
*/
/* Port (other than segment output)/segment outputs specification of Pmn pins (PFSEGxx) */
